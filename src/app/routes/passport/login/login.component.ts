...
@Component({
  ...
  providers: [SocialService, LoginService, RSAEncrypt],
})
export class UserLoginComponent implements OnDestroy, OnInit {
  ...
  getCapchaCode() {
    this.loginService.getCapcha().subscribe((data: any) => {
      this.capchaCode = data.img;
  ...
  submit() {
    ...
    this.loginService
      .login({
        ...
        password: this.rsaEncrypt.encrypted(this.password.value),
