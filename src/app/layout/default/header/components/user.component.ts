...
@Component({
  ...
  template: `
    ...
    >
      <nz-avatar nzIcon="user" nzSize="default" class="mr-sm" style="background-color:#2E8B57;"></nz-avatar>
...
export class HeaderUserComponent {
  ...
  changePwd() {
    this.modal.createStatic(ChangePwdComponent, {}, { size: 'sm' }).subscribe(ret => {
      if (ret === true) {
        this.logout();
      }
    });
